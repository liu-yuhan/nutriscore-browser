...
const FLY_OUT_RADIUS = 80,
  ...
  BASE_ANGLE = (270 - FAN_ANGLE) / 2; // degrees
...
class MenuProfile extends React.PureComponent {
    ...
    if (device_width >= 1281) {
      M_X = -60;
      M_Y = 340;
    } else if (device_width >= 1025 && device_width < 1281) {
      M_X = -100;
      M_Y = 280;
    } else if (device_width >= 768 && device_width < 1025) {
      M_X = 520;
      M_Y = 430;
    } else if (device_width >= 481 && device_width < 768) {
      M_X = 380;
      M_Y = 320;
    } else if (device_width < 481) {
      M_X = 280;
      M_Y = 300;
    }
